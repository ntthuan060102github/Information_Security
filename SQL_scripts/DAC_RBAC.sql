...
GRANT SELECT ON PHANCONG TO ROLE_TRUONGPHONG_ATBM;
...
GRANT SELECT, UPDATE (NGAYSINH, DIACHI, SODT) ON NHANVIEN TO ROLE_NHANSU_ATBM;
GRANT SELECT ON PHONGBAN TO ROLE_NHANSU_ATBM;
...
GRANT SELECT ON DEAN TO ROLE_TRUONGDEAN_ATBM;
...
GRANT SELECT ANY TABLE TO TGD, TP_SX_MN, TP_SX_MB, TP_GC_MN, GB_MB;