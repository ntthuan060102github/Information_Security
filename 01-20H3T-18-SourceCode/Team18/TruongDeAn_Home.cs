...
namespace Team18
{
    public partial class TruongDeAn_Home : Form
    {
        private Button currentButton;
        private Random random;
        private int tempIndex;
        private Form activeForm;
        public TruongDeAn_Home()
        {
            InitializeComponent();
            random = new Random();
        ...
        private void btnDeAn_TruongDeAn_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.TruongDeAn_Form_DeAn(), sender);
        }
    }
}
