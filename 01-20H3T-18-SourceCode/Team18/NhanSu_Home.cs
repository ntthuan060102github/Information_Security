...
namespace Team18
{
    public partial class NhanSu_Home : Form
    {
        ...
        {
            OpenChildForm(new Forms.NhanSu_Form_NVInfo(), sender);
        }
        ...
        private void btnPhongBan_NhanSu_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.NhanSu_Form_PhongBan(), sender);
        }

        private void btnNhanVien_NhanSu_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.NhanSu_Form_NhanVien(), sender);
        }
    }
}
