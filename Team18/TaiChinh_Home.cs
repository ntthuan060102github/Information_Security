...
namespace Team18
{
    public partial class TaiChinh_Home : Form
    {
        private Button currentButton;
        private Random random;
        private int tempIndex;
        private Form activeForm;
        public TaiChinh_Home()
        {
            InitializeComponent();
            random = new Random();
        ...
        private void btnCapNhat_TaiChinh_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.TaiChinh_Form_UpdateNV(), sender);
        }
    }
}
